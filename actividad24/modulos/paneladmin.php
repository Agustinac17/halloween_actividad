...
<section id="admin" class="section">
    ...
    {
        $url = 'index.php?modulo=paneladmin&accion=guardar_editar&id='.$_GET['id'];
        ...
        if(mysqli_num_rows($sql) != 0)
        {
            while($r = mysqli_fetch_array($sql))
            {
                ...
                <tr>
                    ...
                    <td>
                        <a href="index.php?modulo=paneladmin&accion=editar&id=<?php echo $r['id'];?>">Editar</a>
                        -
                        <a href="javascript:if(confirm('Desea eliminar el registro?')) window.location='index.php?modulo=paneladmin&accion=guardar_eliminar&id=<?php echo $r['id'];?>'">Eliminar</a>
                    </td>
                </tr>
                <?php
            }
